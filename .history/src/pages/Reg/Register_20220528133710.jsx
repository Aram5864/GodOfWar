...
const Reg = () => {
    ...
    const Reg = () => {
        if (
            ...
            let arrUsersData = [email,Password];
            let strarrUsersData = JSON.stringify(arrUsersData);
            localStorage.setItem('user', strarrUsersData )
            sessionStorage.setItem('user',strarrUsersData)
