            ...
            <div className="container">
                ...
                >
                    ...
                    <form className="d-flex">
                        ...
                        <button type="button" onClick={translateam}>click</button>
                        <button type="button" onClick={translateen}>click</button>
                        <button type="button" onClick={translateru}>click</button>
                    </form>
                </div>
            </div>
        </nav>
