const Footer = () => {
    return (
        <>
            <footer className={`${style.footer} bd-footer py-4 py-md-5 mt-5 bg-light`}>
                    ...
                    <div className="row">
                        <div className="col-lg-3 mb-3">
                            ...
                            <ul className="list-unstyled small text-muted">
                                <li className="mb-2">
                                    Designed and built with all the love in the
                                    world by the{" "}
                                    <a href="/docs/5.2/about/team/">
                                        Bootstrap team
                                    </a>{" "}
                                    with the help of{" "}
                                ...
                                <li className="mb-2">Currently v5.2.0-beta1.</li>
                            </ul>
                        </div>
                        ...
                        <div className="col-6 col-lg-2 mb-3">
                            ...
                            <ul className="list-unstyled">
                                <li className="mb-2">
                                    <a href="/docs/5.2/getting-started/">
                                        Getting started
                                    </a>
                                </li>
                                <li className="mb-2">
                        ...
                        <div className="col-6 col-lg-2 mb-3">
                            ...
                            <ul className="list-unstyled">
                                ...
                                <li className="mb-2">
                                    <a href="https://github.com/twbs/rfs">
                                        RFS
                                    </a>
                                </li>
                                <li className="mb-2">
                        ...
                        <div className="col-6 col-lg-2 mb-3">
                            ...
                            <ul className="list-unstyled">
                                ...
                                <li className="mb-2">
                                    <a href="https://bootstrap-slack.herokuapp.com/">
                                        Slack
                                    </a>
                                </li>
                                <li className="mb-2">
