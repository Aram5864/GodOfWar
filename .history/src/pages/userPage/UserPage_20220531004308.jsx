...
const UserPage = () => {
    return (
        <>
        <section className={`section ${style.aboutsection}  ${style.graybg}`} id="about">
            <div class="container">
                ...
                <div class={`${style.counter} ${style.userstyle}`}>
                    <div class="row">
                        <div class="col-6 col-lg-3">
                            <div class={`${style.countdata} ${style.textcenter}`}>
                                <h6 class="counth2" data-to="500" data-speed="500">500</h6>
                                <p class="m-0px font-w-600">Happy Clients</p>
                            </div>
                        </div>
                        <div class="col-6 col-lg-3">
                            <div class={`${style.countdata} ${style.textcenter}`}>
                                <h6 class={style.counth2} data-to="150" data-speed="150">150</h6>
                                <p class="m-0px font-w-600">Project Completed</p>
                            </div>
                        </div>
                        <div class="col-6 col-lg-3">
                            <div class={`${style.countdata} ${style.textcenter}`}>
                                <h6 class="counth2" data-to="850" data-speed="850">850</h6>
                                <p class="m-0px font-w-600">Photo Capture</p>
                            </div>
                        </div>
                        <div class="col-6 col-lg-3">
                            <div class={`${style.countdata} ${style.textcenter}`}>
                                <h6 class="counth2" data-to="190" data-speed="190">190</h6>
