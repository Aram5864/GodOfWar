...
const UserPage = () => {
    return (
        <>
        <section className={`section about-section  ${style.graybg}`} id="about">
            <div class="container">
                <div class="row align-items-center flex-row-reverse">
                    <div class="col-lg-6">
                        <div class="about-text go-to">
                            <h3 class={`dark-color ${style.abouttexth3}`}>About Me</h3>
                            <h6 class={`theme-color lead ${style.abouttexth6}`}>A Lead UX &amp; UI designer based in Canada</h6>
                            ...
                            <div class= {`row ${style.about-list}`}>
                                <div class="col-md-6">
                                    <div class="media">
                ...
                <div class={`counter ${style.userstyle}`}>
                    <div class="row">
