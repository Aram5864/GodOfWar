...
const Log = () => {
    ...
    const [emailisvalid, setemsilisvalid] = useState("");
    ...
    const email = (evt) => {
        ...
        if (emailch.length < 3 || emailch.length > 10) {
            setemsilisvalid("invalid");
        } else {
            setemsilisvalid("valid");
        }
    };
    ...
    const password = (evt) => {
        ...
        if (passwordch.length < 3 || passwordch.length > 10) {
            setpassisvalid("invalid");
        } else {
    ...
    const Login = () => {
        if (
            ...
            let locData = localStorage.getItem('user');
    ...
    return (
        <div class={style.bh}>
            <div class={style.wrapper}>
                ...
                <form class="p-3 mt-3">
                    <div
                        class={ ` ${emailisvalid} d-flex align-items-center ${style.form_field}`}
                    >
                    ...
                    <div
                        class={` ${passisvalid}  d-flex align-items-center ${style.form_field}`}
                    >
